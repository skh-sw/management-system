...
from odoo.addons.mgmtsystem_security_event.tests.test_security_event \
    import TestCreateSecurityEventBase

from odoo.netsvc import LocalService
...
class TestRiskMatrix(TestCreateSecurityEventBase):
    ...
    def test_generate_risk_matrix_current(self):
        ...
        """
        self.report.create(
            self.cr, self.uid, [self.matrix.id], {})
